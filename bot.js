...
if(command === "forums") {
  ...
  if(command === "rules") {
    ...
    const m = await message.channel.send("Fatality Discord Rules");

    m.edit(`1. Never post invite links to any other discords in any of the text channels.
2. Do not use your microphone to annoy people in voice channels (blowing into the mic, etc)
3. Do not spam/flood the text channels. Spammers will be muted or banned with no warning depending on how severe the spam is.
4. Do not post ip grabbing links, screamers, or adult content.
Any failure to abide by these rules will result in a warning, mute, kick or Ban.
Rules:
1. No bullying
2. Respect others
3. Disrespect the rules and you will get kicked/banned
4. Don't spam or use abusive/fooling language.`);
}
